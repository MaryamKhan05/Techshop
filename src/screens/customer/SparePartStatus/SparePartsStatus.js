    ...
    useEffect(()=>{
        const getUserRequests = async () => {
            ...
            try {
             ...
             console.log("Spare Part Requests ",pendingRequests)
    ...
    const renderItemPending=({item})=>{
        return(
            ...
            <View style={{height: hp('20%'),width:wp('85%'),paddingHorizontal:wp('3%'),marginVertical:hp('1%'),paddingVertical:hp('2%')}}>
                ...
                <Text style={{fontSize:14 ,fontWeight:'800',textTransform:'capitalize'}}>Spare Part Name: {item.sparePartName}</Text>
...
export default SparePartStatus
